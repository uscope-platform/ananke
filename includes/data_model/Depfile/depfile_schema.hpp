  ...
  "properties": {
    "general": {
      ...
      "properties": {
       ...
       "board": {
          "type": "string",
          "description": "FPGA board to target"
        },
        "synth_tl": {
          "type": "string",
    ...
    "scripts": {
      ...
      "items": {
        ...
        "properties": {
          ...
          "include_products": {
            "type": "boolean",
            "description": "Include the files generated by the script in the project"
          },
          "products_type": {
            "type": "string",
            "description": "Type of the files generated by the script"
          },
          "arguments": {
            "oneOf": [
              {
              ...
              {
                "type": "array",
                "description": "List of named arguments",
                "minItems": 1,
                "items": {
                  "type": "object",
                  "required": ["name", "value"],
