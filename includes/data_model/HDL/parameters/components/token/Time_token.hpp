...
class Time_token: public Expression_base {
public:
    Time_token() = default;
    Time_token(const Time_token &c);

    explicit Time_token(double v);
    ...
    friend bool operator==(const Time_token &lhs, const Time_token &rhs);
