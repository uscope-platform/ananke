...
#ifndef ANANKE_HDL_DO_WHILE_STATEMENT_HPP
#define ANANKE_HDL_DO_WHILE_STATEMENT_HPP
...
class hdl_do_while_statement : public hdl_statement_base {
public:
    ...
    friend void PrintTo(const hdl_do_while_statement& s, std::ostream* os);

    template<class Archive>
    void serialize( Archive & ar ) {
        ar(end_condition, loop_body);
    }
...
#endif //ANANKE_HDL_DO_WHILE_STATEMENT_HPP
