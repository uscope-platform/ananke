...
#ifndef ANANKE_HDL_WHILE_STATEMENT_HPP
#define ANANKE_HDL_WHILE_STATEMENT_HPP
...
class hdl_while_statement : public hdl_statement_base {
public:
    ...
    friend void PrintTo(const hdl_while_statement& s, std::ostream* os);
...
#endif //ANANKE_HDL_WHILE_STATEMENT_HPP
